...
select HS.MAHS, HS.HotenHS,	HS.nienkhoa, L.TENLOP, TK.USERNAME, TK.PASS from HOCSINH AS HS, LOP AS L, TAIKHOAN AS TK WHERE HS.MALOP = L.MALOP AND HS.MATK = TK.MATK
...
FROM HOCSINH AS HS 
WHERE L.MALOP = '{maLop}' OR EXISTS (SELECT * 
										FROM LOPDAHOC 
												WHERE LOPDAHOC.MAHS = HS.MAHS AND LOPDAHOC.MALOP = '{maLop}')
...
SELECT DM.MAMONHOC, CTD.MADIEMMON, CTD.DIEM, CTD.MALOAIKT
                            FROM CHITIETDIEM AS CTD, DIEMMON AS DM 
                WHERE DM.MAHOCSINH = 'HS001' AND DM.MAHK = 'HK1' AND DM.NAMHOC = '2021-2022' AND DM.MADIEMMON = CTD.MADIEMMON

SELECT MAMONHOC, MADIEMMON, TRUNGBINH, MAHK FROM DIEMMON WHERE NAMHOC = '2021-2022' AND MAHOCSINH = 'HS001' ORDER BY MAHK

SELECT COUNT(*) FROM DIEMMON WHERE MAMONHOC = 'MHLS' AND NAMHOC = '2021-2022' AND MAHK = 'HK1' AND MAHOCSINH = 'HS002'
